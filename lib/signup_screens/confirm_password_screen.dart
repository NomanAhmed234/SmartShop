              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style:
                        TextStyle(color: CustomColors.purple.withOpacity(0.5)),
                  ),
        ...
        children: [
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                labelText: "Password",
                labelStyle: TextStyle(color: CustomColors.purple),
    ...
    return Row(
      ...
      children: [
        Text(
          ...
          style: TextStyle(color: CustomColors.purple.withOpacity(0.5)),
        ),
        GestureDetector(
          onTap: () {
          ...
          child: const Text(
            "Sign Up",
            style: TextStyle(
                color: CustomColors.purple, fontWeight: FontWeight.w600),
          ),
        ),
      ],
    );
