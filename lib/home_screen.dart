...
import 'package:sneaker_shoes_app/cart_screen.dart';
...
import 'package:sneaker_shoes_app/skeleton_loader_screen.dart';
import 'package:sneaker_shoes_app/skimmer_widget.dart';
    ...
    return Form(
      child: TextFormField(
        ...
        decoration: InputDecoration(
          filled: true,
          hintStyle: const TextStyle(color: CustomColors.lightGreen),
          fillColor: CustomColors.lightGreen.withOpacity(0.1),
          contentPadding:
          ...
          FutureBuilder<List<CategoryModel>>(
            ...
            builder: (context, snaps) {
              if (snaps.connectionState == ConnectionState.waiting) {
                ...
                List<CategoryModel> category = snaps.data!;
                return SizedBox(
                  height: 40,
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Padding(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    // Example: If products[index].images contains a raw JSON string
                    String rawImageUrls =
                        products[index].images?.isNotEmpty == true
                            ? products[index].images![0]
                            : '';

// Clean the image URLs
                    String cleanedImageUrls =
                        rawImageUrls.replaceAll(RegExp(r'[\[\]\"]'), '');

// Split into a list of URLs
                    List<String> imageUrls = cleanedImageUrls.split(', ');

// Select the appropriate image URL
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(
                                          16.0), // Ensure the radius matches
                                      child: Image.network(
                                        imageUrls[0],
                                        fit: BoxFit.cover,
                                      ),
